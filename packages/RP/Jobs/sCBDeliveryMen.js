...
function updateLanguage(player) {
    ...
    haveUndeliveredText = `You will pay $500 finishing right now!`;
    needMoreLoyalityText = `You need 50 loyality points to start this job!`;
    startText = "Congratulations! You can get new order in the left side";
	...
	if (lang === "rus") {
        ...
        haveUndeliveredText = `Вам выпишут неустойку $500 за недоставленный заказ!`;
        needMoreLoyalityText = `Вам необходимо 50 лояльности для устройства на работу!`;
        startText = "Поздравляем! Взять заказ вы можете у двери слева";
